...
public class RejectedOrderCommand {
    ...
    public RejectedOrderCommand(String orderId, BigInteger clientId, Date date, String direction, String currency,List<ProductCreatedDTO> products, String orderStatus) {

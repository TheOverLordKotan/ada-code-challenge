...
public class RejectedShippingCommand {
    ...
    public RejectedShippingCommand(String shippingId, String orderId, String BillId, BigInteger clientId, Date date, String direction, String currency,List<ProductCreatedDTO> products,String rejected) {
